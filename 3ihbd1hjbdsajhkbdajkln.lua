--[[todo
        ...
        local Window = Rayfield:CreateWindow({
            Name = "MemzWare | 1.0",
            LoadingTitle = "Loading... (join discord https://discord.gg/d9yQ2JNP)",
        ...
        do
            ...
            local Enabled = false
            local Messages = {"Pow!","Thump!","Wham!","Hit!","Smack!","Bang!","Pop!","Boom!", "MemzWarePrivate!", "Kabam!", "Skuuuura!", "Ablam!", "Pha pha!", "inf"}
            local old
